...
#define paging_hvirt2phys(x) ((u64)(x))
...
#define IDR0_ST_LVL			BIT_MASK_LR(28, 27)
#define IDR0_TTENDIAN			BIT_MASK_LR(22, 21)
...
#define IDR0_S2P			(1 << 0)
#define IDR0_S1P			(1 << 1)
#define IDR0_HTTU			BIT_MASK_LR(7, 6)
#define IDR0_COHACC			(1 << 4)
#define IDR0_TTF			BIT_MASK_LR(3, 2)
...
#define IDR1_CMDQS			BIT_MASK_LR(25, 21)
#define IDR1_EVTQS			BIT_MASK_LR(20, 16)
#define IDR1_SSIDSIZE			BIT_MASK_LR(10, 6)
#define IDR1_SIDSIZE			BIT_MASK_LR(5, 0)
...
#define CR1_TABLE_SH			BIT_MASK_LR(11, 10)
#define CR1_TABLE_OC			BIT_MASK_LR(9, 8)
#define CR1_TABLE_IC			BIT_MASK_LR(7, 6)
#define CR1_QUEUE_SH			BIT_MASK_LR(5, 4)
#define CR1_QUEUE_OC			BIT_MASK_LR(3, 2)
#define CR1_QUEUE_IC			BIT_MASK_LR(1, 0)
...
#define STRTAB_BASE_ADDR_MASK		BIT_MASK_LR(51, 6)

#define ARM_SMMU_STRTAB_BASE_CFG	0x88
#define STRTAB_BASE_CFG_FMT		BIT_MASK_LR(17, 16)
#define STRTAB_BASE_CFG_FMT_LINEAR	0
#define STRTAB_BASE_CFG_FMT_2LVL	1
#define STRTAB_BASE_CFG_SPLIT		BIT_MASK_LR(10, 6)
#define STRTAB_BASE_CFG_LOG2SIZE	BIT_MASK_LR(5, 0)
...
#define Q_BASE_ADDR_MASK		BIT_MASK_LR(51, 5)
#define Q_BASE_LOG2SIZE			BIT_MASK_LR(4, 0)
...
#define STRTAB_L1_DESC_SPAN		BIT_MASK_LR(4, 0)
#define STRTAB_L1_DESC_L2PTR_MASK	BIT_MASK_LR(51, 6)
...
#define STRTAB_STE_0_CFG		BIT_MASK_LR(3, 1)
#define STRTAB_STE_0_CFG_ABORT		0
#define STRTAB_STE_0_CFG_BYPASS		4
#define STRTAB_STE_0_CFG_S1_TRANS	5
#define STRTAB_STE_0_CFG_S2_TRANS	6
#define STRTAB_STE_0_S1CTXPTR		BIT_MASK_LR(51, 6)
#define STRTAB_STE_0_S1CDMAX		BIT_MASK_LR(63, 59)
#define STRTAB_STE_1_S1DSS		BIT_MASK_LR(1, 0)
#define STRTAB_STE_1_S1CIR		BIT_MASK_LR(3, 2)
#define STRTAB_STE_1_S1COR		BIT_MASK_LR(5, 4)
#define STRTAB_STE_1_S1CSH		BIT_MASK_LR(7, 6)
#define STRTAB_STE_1_S1STALLD		(1UL << 27)
#define STRTAB_CTXDESC_DWORDS		8
#define STRTAB_CTXDESC_S1CTXPTR_SHIFT	6

#define STRTAB_STE_1_SHCFG		BIT_MASK_LR(45, 44)
#define STRTAB_STE_1_SHCFG_INCOMING	1UL

#define STRTAB_STE_2_S2VMID		BIT_MASK_LR(15, 0)
#define STRTAB_STE_2_VTCR		BIT_MASK_LR(50, 32)
#define STRTAB_STE_2_S2AA64		(1UL << 51)
#define STRTAB_STE_2_S2ENDI		(1UL << 52)
#define STRTAB_STE_2_S2PTW		(1UL << 54)
#define STRTAB_STE_2_S2R		(1UL << 58)

#define STRTAB_STE_3_S2TTB_MASK		BIT_MASK_LR(51, 4)

#define CTXDESC_1_TTB0			BIT_MASK_LR(51, 4)
#define CTXDESC_2_TTB1			BIT_MASK_LR(51, 4)
...
#define CMDQ_CONS_ERR			BIT_MASK_LR(30, 24)
#define CMDQ_ERR_CERROR_NONE_IDX	0
#define CMDQ_ERR_CERROR_ILL_IDX		1
#define CMDQ_ERR_CERROR_ABT_IDX		2

#define CMDQ_0_OP			BIT_MASK_LR(7, 0)
#define CMDQ_0_SSV			(1UL << 11)

#define CMDQ_PREFETCH_0_SSID		BIT_MASK_LR(31, 12)
#define CMDQ_PREFETCH_0_SID		BIT_MASK_LR(63, 32)
#define CMDQ_PREFETCH_1_SIZE		BIT_MASK_LR(4, 0)
#define CMDQ_PREFETCH_1_ADDR_MASK	BIT_MASK_LR(63, 12)

#define CMDQ_CFGI_0_SID			BIT_MASK_LR(63, 32)
#define CMDQ_CFGI_1_LEAF		(1UL << 0)
#define CMDQ_CFGI_1_RANGE		BIT_MASK_LR(4, 0)

#define CMDQ_TLBI_0_VMID		BIT_MASK_LR(47, 32)
#define CMDQ_TLBI_0_ASID		BIT_MASK_LR(63, 48)
#define CMDQ_TLBI_1_LEAF		(1UL << 0)
#define CMDQ_TLBI_1_VA_MASK		BIT_MASK_LR(63, 12)
#define CMDQ_TLBI_1_IPA_MASK		BIT_MASK_LR(51, 12)

#define CMDQ_PRI_0_SSID			BIT_MASK_LR(31, 12)
#define CMDQ_PRI_0_SID			BIT_MASK_LR(63, 32)
#define CMDQ_PRI_1_GRPID		BIT_MASK_LR(8, 0)
#define CMDQ_PRI_1_RESP			BIT_MASK_LR(13, 12)

#define CMDQ_SYNC_0_CS			BIT_MASK_LR(13, 12)
#define CMDQ_SYNC_0_CS_NONE		0
#define CMDQ_SYNC_0_CS_IRQ		1
#define CMDQ_SYNC_0_CS_SEV		2
#define CMDQ_SYNC_0_MSH			BIT_MASK_LR(23, 22)
#define CMDQ_SYNC_0_MSIATTR		BIT_MASK_LR(27, 24)
#define CMDQ_SYNC_0_MSIDATA		BIT_MASK_LR(63, 32)
#define CMDQ_SYNC_1_MSIADDR_MASK	BIT_MASK_LR(51, 2)

/* Event queue */
#define EVTQ_ENT_DWORDS			4
#define EVTQ_MAX_SZ_SHIFT		7

#define EVTQ_0_ID			BIT_MASK_LR(7, 0)
...
struct arm_smmu_device smmu_device;
...
static void arm_smmu_write_strtab_ent(struct arm_smmu_device *smmu, u32 sid,
	...
	vttbr = paging_hvirt2phys(root_pt);
...
static void arm_smmu_init_bypass_stes(u64 *strtab, unsigned int nent) {
	...
	for (n = 0; n < nent; ++n) {
		arm_smmu_write_strtab_ent(NULL, -1, NULL, strtab, true, 
									CURRENT_VM->id, (paddr_t) CURRENT_VM->as.pt.root);
...
static int arm_smmu_init_strtab_linear(struct arm_smmu_device *smmu) {
	...
	strtab = mem_alloc_page(NUM_PAGES(size), true);
	if (!strtab)
		return -ENOMEM;
...
static int arm_smmu_init_l1_strtab(struct arm_smmu_device *smmu) {
	...
	cfg->l1_desc = mem_alloc_page(NUM_PAGES(size), false);
	if (!cfg->l1_desc)
		return -ENOMEM;
...
static int arm_smmu_init_strtab_2lvl(struct arm_smmu_device *smmu) {
	...
	if (size < smmu->sid_bits) {
		WARNING("SMMU 2-level strtab only covers %u/%u bits of SID\n",
		       size, smmu->sid_bits);
		smmu->sid_bits = size;
	}

	l1size = cfg->num_l1_ents * STRTAB_L1_DESC_SIZE;
	strtab = mem_alloc_page(NUM_PAGES(l1size), true);
	if (!strtab)
		return -ENOMEM;
...
static int arm_smmu_device_init_features(struct arm_smmu_device *smmu) {
	...
	reg = mmio_read32(smmu->base + SMMU_AIDR);
	INFO("SMMUV3 AIDR: 0x%x", reg);
...
static int arm_smmu_init_l2_strtab(struct arm_smmu_device *smmu, u32 sid) {
	...
	desc->l2ptr = mem_alloc_page(NUM_PAGES(size), true);
	if (!desc->l2ptr)
...
int arm_smmuv3_vm_dev_init(vmid_t vmid, streamid_t sid) {
	...
	ret = arm_smmu_init_ste(smmu, sid, vmid);
	if (ret)
		return ret;
...
// static void arm_smmuv3_cell_exit() {
// 	struct arm_smmu_device *smmu = &smmu_devices;
...
void arm_smmuv3_init() {
	...
	smmu->base = (void*) platform.arch.smmu.base;
